...
DROP POLICY IF EXISTS "System can create redemptions" ON public.promo_code_redemptions;
...
-- Add promo_code_discount column to subscriptions table
ALTER TABLE public.subscriptions 
ADD COLUMN IF NOT EXISTS promo_code_discount INTEGER DEFAULT 0,
