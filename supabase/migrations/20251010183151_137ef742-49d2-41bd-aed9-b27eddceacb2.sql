-- Schedule continuous deepfake scanning every 5 minutes
SELECT cron.schedule(
  'continuous-deepfake-scanning',
  '*/5 * * * *', -- Every 5 minutes
  $$
  SELECT
    net.http_post(
      url:='https://utneaqmbyjwxaqrrarpc.supabase.co/functions/v1/continuous-deepfake-scanner',
      ...
      body:='{"action": "scheduled_deepfake_scan"}'::jsonb
    ) as request_id;
  $$
);