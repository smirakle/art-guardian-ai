-- Enable real-time for existing legal tables
ALTER PUBLICATION supabase_realtime ADD TABLE legal_professionals;
ALTER PUBLICATION supabase_realtime ADD TABLE legal_consultations;
...
ALTER TABLE legal_consultations REPLICA IDENTITY FULL;
ALTER TABLE legal_notifications REPLICA IDENTITY FULL;
ALTER TABLE legal_documents REPLICA IDENTITY FULL;
