...
const AdminProtectedPatentDocs = () => {
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700">
                  Please sign in to access patent documentation. This content is restricted to authenticated users.
                </p>
              </div>
            </div>
          </div>
        ...
        <CardContent className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700">
                  Patent documentation is restricted to administrators only. This content contains confidential 
                  intellectual property information and filing strategies.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-xs text-muted-foreground">
              Contact an administrator if you need access to patent documentation.
            </p>
          </div>
        </CardContent>
      </Card>
  ...
  // User is authenticated and has admin role - show the patent documents
  return <ComprehensivePatentDocument />;
};

export default AdminProtectedPatentDocs;