...
const ARCHITECTURE_DOC = {
  ...
  section_3_cryptographic_implementation: {
    ...
    dependency_management: 'All edge function imports are version-pinned to exact versions: deno.land/std@0.192.0, @supabase/supabase-js@2.50.5, stripe@14.21.0, resend@2.0.0. GitHub Dependabot is configured (.github/dependabot.yml) for weekly vulnerability scanning. A CycloneDX SBOM manifest is maintained at scripts/generate-sbom.json. The dependency-inventory edge function serves a live audit-ready inventory.',
  },
