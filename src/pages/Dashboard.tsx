          ...
          <TabsContent value="scanning" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Automated daily summaries of your protection activities
                </CardDescription>
              </CardHeader>
              <CardContent>
                <DailyReport />
          ...
          <TabsContent value="blockchain" className="space-y-6">
            <FeatureGuard feature="blockchain">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Live NFT Status</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <LiveNFTStatusFeed />
                  </CardContent>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Gas Price Tracker</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <NFTGasPriceTracker />
                  </CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Advanced Blockchain Features</CardTitle>
                  <CardDescription>
                    Enhanced blockchain integration and verification tools
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <AdvancedBlockchain />
            ...
            <FeatureGuard feature="white_label">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Customize and manage your branded protection platform
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <WhiteLabelManager />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Your protection summary</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Protection Level</span>
                    <Badge variant={stats.protectionScore > 80 ? "default" : stats.protectionScore > 50 ? "secondary" : "destructive"}>
                      {stats.protectionScore > 80 ? "High" : stats.protectionScore > 50 ? "Medium" : "Low"}
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Threat Level</span>
                    <Badge variant={stats.recentThreatLevel === 'low' ? "default" : stats.recentThreatLevel === 'medium' ? "secondary" : "destructive"}>
                      {stats.recentThreatLevel}
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Active Scans</span>
                    <span className="text-sm font-medium">{stats.activeScans}</span>
                  </div>
                </CardContent>
              </Card>
            </div>
